...
{
	[TransformationDiagnostic("DarkPatterns.OpenApi.Transformations.Specifications.OpenApi3_0.TypeKeywordMismatch")]
	public static readonly DiagnosticDescriptor OpenApi30TypeKeywordMismatch =
		new DiagnosticDescriptor(id: "DPD_OPENAPI_3_0_001",
								...
								messageFormat: DarkPatterns_OpenApi_Transformations_Specifications_OpenApi3_0_TypeKeywordMismatch,
								category: "DarkPatterns.OpenApiCodegen",
								DiagnosticSeverity.Error,
								isEnabledByDefault: true);
	[TransformationDiagnostic("DarkPatterns.OpenApi.Transformations.Specifications.OpenApi3_0.InvalidNode")]
	public static readonly DiagnosticDescriptor OpenApi30InvalidNode =
		new DiagnosticDescriptor(id: "DPD_OPENAPI_3_0_002",
								...
								messageFormat: DarkPatterns_OpenApi_Transformations_Specifications_OpenApi3_0_InvalidNode,
								category: "DarkPatterns.OpenApiCodegen",
								DiagnosticSeverity.Error,
								isEnabledByDefault: true);
}
