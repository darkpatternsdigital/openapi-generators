		...
		if (requestBodies.Length > 0)
		{
			argument.RegisterControllerOperation(
				new Operation(
				 ...
				 Name: CSharpNaming.ToTitleCaseIdentifier(operationId, options.ReservedIdentifiers(controllerClassName)),
				 AbstractTypeName: CSharpNaming.ToTitleCaseIdentifier("i " + operationId + " request handler", options.ReservedIdentifiers(controllerClassName)),
				 Path: path,
